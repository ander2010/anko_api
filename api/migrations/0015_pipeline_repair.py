# Generated to normalize pipeline tables and section schema
from django.db import migrations

SQL = r"""
-- Drop FKs only if tables exist
DO $$
BEGIN
...
-- Clean non-numeric document_id rows
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='chunks') THEN
...
-- Change document_id to BIGINT; add job_id to documents
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='documents') THEN
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("api", "0014_merge_0013_alter_qapair_options_and_more_fix"),
    ]
